            ...
            {userRole === 'Organizer' &&
              <li className="nav-item dropdown customNavbar-dropdown">
                <a className=" icon-link nav-link dropdown-toggle bg-login px-3 border border-2 border-black" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  ...
                  <span className="d-none d-md-inline fw-bold">{userName}</span>
                </a>
                <ul className="dropdown-menu dropdown-menu-end">
                  ...
                  <li className="nav-item ps-3 dropdown-item">
                    <Link className="nav-link" to='/organizer/event/new'>活動新增</Link>
                  </li>
                  <li className="nav-item ps-3 dropdown-item">
                    <Link className="nav-link " to='/events'>活動訂單</Link>
                  </li>
                  <li className="nav-item ps-3 dropdown-item">
                    <Link className="nav-link" to='/ticketScaner'>驗票</Link>
                  </li>
            ...
            {userRole === 'Admin' &&
              <li className="nav-item dropdown customNavbar-dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end">
                  ...
                  <li className="nav-item ps-3 dropdown-item">
                    <Link className="nav-link" to='/userList'>一般會員管理</Link>
                  </li>
                  <li className="nav-item ps-3 dropdown-item">
                    <Link className="nav-link" to='/eventsList'>活動管理</Link>
                  </li>
                  <li className="nav-item ps-3 dropdown-item" onClick={() => logout()}>
                    <Link className="nav-link" to='/'>登出</Link>
                  </li>
            ...
            {userRole === 'General' &&
              <li className="nav-item dropdown customNavbar-dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end">
                  ...
                  <li className="nav-item ps-3 dropdown-item">
                    <Link className="nav-link" to='/personal'>會員資訊</Link>
                  </li>
                  <li className="nav-item ps-3 dropdown-item">
