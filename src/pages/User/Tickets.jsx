                  ...
                  <div className="d-flex flex-column-reverse flex-sm-row justify-content-between align-items-sm-center align-items-start">
                    ...
                    <div className=" my-2 flex-shrink-0 text-black">
                      {product.ticket_status === 'used' ? (
                        <p className=" border-bottom border-top border-secondary border-3 p-1 m-0">已使用</p>
                      ) : product.ticket_status === 'refunded' ? (
                        <p className=" border-bottom border-top border-dark border-3 p-1 m-0 text-muted">已退票</p>
                      ) : (
                        <p className=" border-bottom border-top border-danger border-3 p-1 m-0 fw-bold">尚有未使用票券</p>
                      )}
                    </div>
